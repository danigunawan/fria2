...
user = User.create!(first_name: 'Dawn', last_name: 'Fernandez', department: 'CE', rank: 'Professor', contact_number: '9142469837', email: 'researcher1@up.edu.ph', password: 'researcher1')
...
user = User.create!(first_name: 'Isabel', last_name: 'Lawrence', department: 'CS', rank: 'Professor', contact_number: '9333867460', email: 'researcher2@up.edu.ph', password: "researcher2")
user.researcher.save!
researcher = user.researcher
...
user = User.create!(first_name: 'Emmett', last_name: 'Alvarez', department: 'CE', rank: 'Professor', contact_number: '9835583620', email: 'admin@up.edu.ph', password: 'admin')
user.admin.activated = true
user.admin.save!

user = User.create!(first_name: 'Penny', last_name: 'Sims', department: 'ECE', rank: 'Professor', contact_number: '9653778294', email: 'committee_head@up.edu.ph', password: "committee_head")
...
user = User.create!(first_name: 'Beverly', last_name: 'Schmidt', department: 'CS', rank: '5', contact_number: '9768465839', email: 'committee_member1@up.edu.ph', password: "committee_member1")
...
user = User.create!(first_name: 'Tracy', last_name: 'Ruiz', department: 'ME', rank: 'Professor', contact_number: '9768465838', email: 'committee_member2@up.edu.ph', password: "committee_member2")
user.committee_member.activated = true
user.committee_member.save!
committee_member = user.committee_member
review = committee_member.reviews.create!(proposal_id: proposal.id, vote: -1, is_decided: true)

user = User.create!(first_name: 'Guadalupe', last_name: 'Leonard', department: 'CoE', rank: 'Professor', contact_number: '9768465839', email: 'dean@up.edu.ph', password: "dean")
