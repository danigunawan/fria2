...
proposal = researcher.proposals.create!(title: 'Oil leakage sensors installation in the West Philippine Sea', researcher_name: 'Isabel Lawrence', coresearchers: 'Spencer Brown', objectives: 'To immediately alarm the crew and coast guards of potential oil leakages.', descriptions: 'The sensor is built using radio waves which can sense large amounts of interference because of the density of the oil as compared to sea water.', is_assigned_reviewers: true, is_decided: false, avatar: File.open(Rails.root + "app/assets/test_uploads/test.pdf"))
