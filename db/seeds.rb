...
proposal.submission_period = SubmissionPeriod.create!(start_draft: DateTime.parse("13th Jan 2017 8:00:00 PM"), end_draft: DateTime.parse("20th Dec 2018 8:00:00 PM"), start_votation: DateTime.parse("22th Jan 2017 8:00:00 PM"), end_votation: DateTime.parse("20th Dec 2018 8:00:00 PM"), is_set: true, is_active_draft: false, is_active_votation: true)
